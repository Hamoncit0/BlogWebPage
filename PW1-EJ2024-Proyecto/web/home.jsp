    ...
    <body>
        ...
        <div class="settings-menu">
          <div class="settings-menu-inner">
            ...
            <div class="user-profile">
              ...
              <div>
                <p id="NombreUsuScripsUnico" data-usuario="${UserObj.getUsuario()}"><%out.println(uwu.getUsuario());%></p>
     ...
     <div class="main">
      ...
      <div class="section-middle" id="middle">
          <form id="postForm" action="MakeAPostServlet" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
...
function validateForm() {
    ...
    var title = document.querySelector('input[name="Titulo"]').value;
    var content = document.querySelector('textarea[name="Contenido"]').value;
